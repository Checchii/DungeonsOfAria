	...
	switch(sub_menu) {
		...
		case CONTROLS:
			switch(index){
				...
				case 0:
					// "UP"
					change_controls(_hmove, "key_up");
				break;
				
				case 1:
					// left
					change_controls(_hmove, "key_left");
				break;
				
				case 2:
					// right
					change_controls(_hmove, "key_right");
				break;
				
				case 3:
					// down
					change_controls(_hmove, "key_down");
				break;
